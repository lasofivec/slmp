    ...
    for l in range(3):
        for k in range(1,5):
            ...
            if l == 0 :
                ...
                for m in range(l):
                    fmkml[m] = get_face(data_br, face_br, indx=k)[m] #TODO
                    fmkpl[-m-1] = get_face(data_bl, face_bl, indx=k)[-m-1] # TODO
                    fpkml[m] = get_face(data_ur, face_ur, indx=k)[m] #TODO
                    fpkpl[-m-1] = get_face(data_ul, face_ul, indx=k)[-m-1] # TODO
            # updating result
